...
/**
 * @typedef {import("./themes/redis-color-theme.json")} Theme
 */
...
function generate(variant) {
  ...
  return {
    ...
    colors: {
      ...
      "editorWarning.foreground": redDim,
    },
    tokenColors: [
      {
        name: "Comment",
...
fs.writeFileSync("./themes/redis-color-theme.json", JSON.stringify(dark, null, 2));
